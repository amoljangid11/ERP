...
@Component({
  selector: 'app-pending1',
  templateUrl: './pending1.component.html',
  styleUrls: ['./pending1.component.css']
})
export class Pending1Component implements OnInit {
  ...
  checkk(){
    this.obk=this.allss.filter(obj => obj.allservicereq[0].status != "cancelled" && !obj.allservicereq[0].executorstatus && (obj.allservicereq[0].management1status || obj.allservicereq[0].finalmanagerstatus))
 }
