...
objjj;
  fetch(){
this.objjj=this.allss.filter(obj => obj.allservicereq[0].status=='cancelled')
console.log(this.objjj)
  ...
  // {
  //   console.log(ddt)
  //   alls.allservicereq[0].category=bunitobj._id
  //   console.log(alls.allservicereq[0].category)
  //   console.log(this.alls)
  //   var dp3 = [];
  //   dp3 = this.reqq.filter(data => data.requesttype[0].category_id == bunitobj._id)
  //   this.dd = dp3;
  // }
