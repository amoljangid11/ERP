...
@Component({
  selector: 'app-mclosed',
  templateUrl: './mclosed.component.html',
  styleUrls: ['./mclosed.component.css']
})
export class MclosedComponent implements OnInit {
  ...
  checkk(){
    this.management1=this.allss.filter(obj => obj.allservicereq[0].executorstatus=='Approved' || obj.allservicereq[0].executorstatus=='Rejected')
    this.management2=this.allss1.filter(obj => obj.allservicereq[0].executorstatus=='Approved' || obj.allservicereq[0].executorstatus=='Rejected')
    this.management3=this.allss2.filter(obj => obj.allservicereq[0].executorstatus=='Approved' || obj.allservicereq[0].executorstatus=='Rejected')
