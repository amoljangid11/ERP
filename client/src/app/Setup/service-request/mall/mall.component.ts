...
export class MallComponent implements OnInit {
  ...
  checkk(){
    this.management1=this.allss.filter(obj => obj.allservicereq[0].status )
    this.management2=this.allss1.filter(obj => obj.allservicereq[0].status )
    this.management3=this.allss2.filter(obj => obj.allservicereq[0].status )
