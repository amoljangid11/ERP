...
@Component({
  selector: 'app-grproleemp',
  templateUrl: './grproleemp.component.html',
  styleUrls: ['./grproleemp.component.css']
})
export class GrproleempComponent implements OnInit {
